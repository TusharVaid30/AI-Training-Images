    ...
    public override void UpdateBorders()
    {
        ...
        for (var x = (int) bottomLeft.x; x < topRight.x; x += factorX)
        {
            for (var y = (int) bottomLeft.y; y < topRight.y; y += factorY)
            {
                ...
                {
                    if ((hit.transform.CompareTag("Front Bumper") && transform.name == "Front Bumper") || (hit.transform.CompareTag("Rear Bumper") && transform.name == "Rear Bumper") || hit.transform == transform)
                    {
        ...
        for (var x = (int) topRight.x; x > topRight.x; x -= factorX)
        {
            for (var y = (int) topRight.y; y > bottomLeft.y; y -= factorY)
            {
                ...
                if (Physics.Raycast(ray, out hit))
                {
                    if (hit.transform == transform || (hit.transform.CompareTag("Rear Bumper") && transform.name == "Rear Bumper") || (hit.transform.CompareTag("Front Bumper") && transform.name == "Front Bumper"))
                    {
